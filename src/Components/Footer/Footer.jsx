  ...
  return (
    <footer className="bg-black text-white py-10  ">
      <div className="container mx-auto px-4">
        ...
        <div>
            <img src="/Images/logo.png" alt="Auto Zoom" className="mb-4 w-20 lg:w-24 md:w-20" />
            <h2 className="text-xl font-lato mb-4">LUXURY CAR RENTAL IN DUBAI</h2>
            <p className='font-lato text-[15px]'>Rent sports and luxury cars directly without intermediaries. Rent a car in Dubai with Auto Zoom Car Rental - safety and driving pleasure</p>
            <button className="mt-4 px-6 font-lato hover:bg-orange-500 py-3 bg-black text-white border rounded-xl ">GET BEST OFFER</button>
          </div>
          <div>
          ...
          <Link className="text-lg font-lato lg:mb-4 mb-2 block">FAQ</Link>
            ...
            <div className="flex space-x-3 items-center">
              ...
              <a href="#" className="text-xl"><FontAwesomeIcon className='hover:text-orange-500' icon={faFacebook}/></a>
              <a href="#" className="text-xl"><FontAwesomeIcon className='hover:text-orange-500' icon={faYoutube}/></a>
            </div>
          </div>
        </div>
        <div className="border-t border-gray-700 mt-8 pt-4 text-center">
          <p>© 2024 Auto Zoom Car Rental. United Arab Emirates.</p>
          <a href="#" className="block mt-2">Terms and Conditions</a>
        </div>
      </div>
    </footer>
  );
